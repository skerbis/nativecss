...
for (const lang of LANGS) {
  ...
  flatPages.forEach((page, index) => {
    ...
    html = html
      ...
      .replaceAll("__NAV_NAVIGATION__", s.navNavigation)
      .replaceAll("__NAV_FORMS__", s.navForms)
      .replaceAll("__NAV_MEDIA__", s.navMedia)
      .replaceAll("__NAV_MORE__", s.navMore)
      .replaceAll("__NAV_MAGAZINE__", s.navMagazine)
      .replaceAll("__NAV_SCROLL_SECTIONS__", s.navScrollSections)
      .replaceAll("__NAV_STACKED_CARDS__", s.navStackedCards)
      .replaceAll("__NAV_ROADMAP__", s.navRoadmap)
      .replaceAll("__NAV_COLORS__", s.navColors)
      .replaceAll("__NAV_LANDING__", s.navLanding)
      .replaceAll("__NAV_EFFECTS__", s.navEffects)
      .replaceAll("__NAV_THEMING__", s.navTheming)
      .replaceAll("__NAV_WIDGETS__", s.navWidgets)
      .replaceAll("__NAV_UIKIT_INTEGRATION__", s.navUikitIntegration)
      .replaceAll("__NAV_GUIDES__", s.navGuides)
